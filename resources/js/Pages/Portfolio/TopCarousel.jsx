         ...
         <Carousel id="topCarousel" className="d-flex justify-content-center top-carousel">
                ...
                <Carousel.Item>
                    <Carousel.Caption>
                        ...
                        <a href="https://lar10reactmix.rsypertjr.net/votes-table" 
                ...
                <Carousel.Item>
                    <Carousel.Caption>
                        ...
                        Link to this code is <a href="https://github.com/Rsypertjr/Docker-Laravel-Vite-React-Bootstrap-Chartjs/tree/docker-laravel-vite" target="_blank">Docker Laravel-Vite/React Code</a><br/><a href="https://preselections.rsypertjr.net/" target="_blank">See App</a>
                        </p>
                    </Carousel.Caption>								
                </Carousel.Item>
                <Carousel.Item>
