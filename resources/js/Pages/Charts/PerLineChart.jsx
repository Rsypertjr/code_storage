...
export default function PerLineChart(props) {
    ...
    const getDatasets = (chartData,selected_index,type,label) => {
        ...
        if((selected_index - 1) < chartData.perRemainingBidenStore.length) {
            ...
            let last_index = chartData.perRemainingBidenStore.length - 1;
    ...
    const getDataSetPerIndex = (index,chartData) => {
        ...
        data1.data = [];
        perremainingbiden_store[index].map((data) => {
        ...
        data2.data = [];
        perremainingtrump_store[index].map((data) => {
