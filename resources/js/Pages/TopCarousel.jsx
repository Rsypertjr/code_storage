         ...
         <Carousel className="d-flex justify-content-center">
                <Carousel.Item>
                    ...
                    <Carousel.Caption>
                        ...
                        <p className="text-break">This site shows my experience as a Software Developer,Technical Writer,and Engineer.  t has been updated to Bootstrap 4.0. Please View thru 
                ...
                <Carousel.Item>
                    ...
                    <Carousel.Caption>
                        ...
                        <p> Fuel CMS framework (CodeIgniter-based)</p>
                    </Carousel.Caption>								
                </Carousel.Item>					
                <Carousel.Item>
                    <CarouselImage text="First slide" />
                    <Carousel.Caption>
                        ...
                        <p>Laravel (Mix) with React.js,&nbsp;React Router,&nbsp;Chart.js,&nbsp;and Bootstrap is used in this app:&nbsp;
                ...
                <Carousel.Item>
                    ...
                    <Carousel.Caption>
                        ...
                        <p>Google Programmable API is used to target searches at selected Web Sites and Customize Return Info:<br/>
