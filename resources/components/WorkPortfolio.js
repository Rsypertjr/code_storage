...
export default class WorkPortfolio extends React.Component {
    ...
    render(){
        return(
            <div>
                <Container className="py-4 mb-5 rounded-4">
                    ...
                    <Row className="p-3 mb-4 top rounded-3">
                        <Container className="fluid py-2 top-container">
                ...
                <MyNavbar/>
                <Container>
                    <Row style={infoStyle} className="d-flex justify-content-center">
                        Please Select an App or Document from the Menu Above and it will Appear!
                    </Row>                        
                </Container>
            </div>
